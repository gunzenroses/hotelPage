class CheckboxExpandable {
  ...
  createChildren() {
    this.dropdownInit = this.dropdown.querySelector('.js-checkbox-expandable__init');
    this.dropdownExpand = this.dropdown.querySelector('.js-checkbox-expandable__content');
